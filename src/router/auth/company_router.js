...
const { createCompany, verifyEmail, verifyOtp, updateCompany, addEmployee, viewCompanyOrProfile,deleteCompany, deleteEmployee } = require("../../controller/auth/company_controller");
